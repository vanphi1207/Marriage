...
public class AdminSetCommand implements SubCommand {

    private final MarriageService marriageService;
    private final MessageService messages;

    public AdminSetCommand(@NotNull MarriagePlugin plugin) {
    ...
    public void execute(@NotNull CommandSender sender, @NotNull String[] args) {
        ...
        marriageService.forceMarriage(p1.getUniqueId(), p2.getUniqueId(), sender);
    }
